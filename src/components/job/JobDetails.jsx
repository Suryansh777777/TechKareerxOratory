...
const JobDetails = () => {
  return (
    <div className="mt-8 ">
      <h2 className="text-lg font-medium text-[#6E6D6D] mb-4">About the job</h2>
      <ul className="list-decimal text-[#3D3D3D] list-inside space-y-2 mb-6">
      ...
      <ul className="list-disc list-inside space-y-1 text-[#3D3D3D]  mb-4">
